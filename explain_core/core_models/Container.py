...
class Container:
    def __init__(self, model, **args):
        ...
        self.u_vol_fac = 1.0                # holds the unstressed volume in liters
        ...
        self.el_base_fac = 1.0              # holds the baseline elastance
        self.el_k = 0                       # holds the constant for the non-linear elastance function
        self.el_k_fac = 1.0                 # holds the constant for the non-linear elastance function
    ...
    def calculate_pressure(self):
        ...
        self.pres = self.recoil_pressure + self.pres_outside + self.p_atm + self.itp
